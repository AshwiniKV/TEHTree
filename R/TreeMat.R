#' TEHTree matrix
#'
#' @param orig.LT Output from the LMEtree
#' @param orig.Y Responses from the matched dataset
#' @param orig.X Covariates from the matched dataset
#' @export
#' @return Tree structure recorded as a matrix
#'
#'
#'
#'
